<%@ Page Title="" Language="C#" MasterPageFile="~/Master_Page.Master" AutoEventWireup="true" CodeBehind="userprofile.aspx.cs" Inherits="E_LibraryManagement.userporfile" %>
                        ...
                        <div class="row">
                            <div class="col">
                                <center>
                                    ...
                                    <asp:Label class="badge badge-pill badge-info" ID="Label2" runat="server" Text="Information about book due date"></asp:Label>
                                </center>
                                <hr />
                            </div>
                        </div>
